...
char ar[size];
char bedrag[4];
char rekeningNummer[5];
char transactieNummer[5];
char date[11];
char time1[6];
...
//    for (int index = 0; index < size; index++) {
      // turn the pin on:
      Serial.readBytes(bedrag, 3);
      Serial.readBytes(rekeningNummer, 4);
      Serial.readBytes(transactieNummer, 4);
      Serial.readBytes(date, 10);
      Serial.readBytes(time1, 5);
      Serial.read();
//    }
//    bedrag = "";
//    rekeningNummer = "";
